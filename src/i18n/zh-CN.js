export const zhCN = {
    ...
    editor: {
        ...
        exportSvgSuccess: 'SVG 已导出',
        dropNodeHere: '拖入节点到此处',
        ...
        workflowDescPlaceholder: '添加描述...',
        editWorkflowInfo: '编辑工作流信息',
        clickToEditInfo: '点击编辑名称和描述',
        shortcuts: '快捷键',
        exportDropdown: '导出',
        moreDropdown: '更多',
        savedJustNow: '刚刚已保存',
    ...
    nodeParams: {
        ...
        option_type: '选项来源',
        options: '选项列表',
        dynamic_option: '动态选项表达式',
        extra_output: '额外输出',
        question: '问题内容',
        option_name: '选项名称',
        option_value: '选项值',
        option_empty_hint: '当前为文本模式，选项不生效',
        limit: '选项数量限制',
        mergeStrategy: '合并策略',
        inputArray: '输入数组',
        batchSize: '批量大小',
    ...
    messages: {
        ...
        workflowExported: '工作流导出成功，可导入 Coze 平台',
        canvasCleared: '画布已清空',
    ...
    manager: {
        ...
        zipDetected: '已检测到 ZIP 压缩包，点击导入将自动解压并解析工作流',
        noDescription: '暂无描述',
        ...
        batchCount: '已选 {count} 项',
        batchDeleteConfirm: '确定要删除选中的 {count} 个工作流吗？',
        batchDeleteTitle: '批量删除',
        batchDeleteSuccess: '批量删除成功',
        dragHandle: '拖拽排序',
        duplicateWorkflowTip: '复制工作流',
        versionCompare: '版本对比',
        versionCompareTitle: '版本对比 - {name}',
        versionCompareClose: '关闭',
        versionCompareRun: '对比',
        versionCompareSelect: '请选择两个不同的版本进行对比',
        versionCompareNoHistory: '暂无版本历史记录',
        versionOption: '版本 {index} ({time}) - {count}个节点',
        versionAOld: '版本A（旧版）',
        versionBNew: '版本B（新版）',
        versionSummary: '变更摘要',
        versionDetail: '变更详情',
        versionItem: '项目',
        versionNewNodes: '新增 {count} 个节点: {list}',
        versionDeletedNodes: '删除 {count} 个节点: {list}',
        versionModifiedNodes: '修改 {count} 个节点:',
        versionNewEdges: '新增 {count} 条连线',
        versionDeletedEdges: '删除 {count} 条连线',
        versionNoDiff: '两个版本没有差异',
