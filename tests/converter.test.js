    ...
    describe('convertYamlToClipboard', () => {
        it('should convert complete workflow', () => {
            const yaml = {
                ...
                edges: [{ source_node: 'node_1', target_node: 'node_2' }],
            };
        ...
        it('should handle empty workflow name', () => {
            const yaml = {
                id: 'workflow_002',
                nodes: [{ id: 'node_1', type: 'start', title: '开始', position: { x: 0, y: 0 } }],
                edges: [],
            };
        ...
        it('should throw enriched error with node info on conversion failure', () => {
            const yaml = {
                id: 'wf',
                nodes: [{ id: 'bad_node', type: 1, title: 'Bad' }],
                edges: [],
            };
            try {
        ...
        it('should handle rawYaml for error line info', () => {
            ...
            const yaml = {
                id: 'wf',
                nodes: [{ id: 'node_1', type: 'start', title: 'Start', position: { x: 0, y: 0 } }],
                edges: [],
            };
        ...
        it('should handle workflow with name only (no id)', () => {
            const yaml = {
                name: 'Named Workflow',
                nodes: [{ id: 'n1', type: 'start', title: '开始', position: { x: 0, y: 0 } }],
                edges: [],
            };
            const result = convertYamlToClipboard(yaml);
                ...
                nodes: [
                    {
                        ...
                        position: { x: 0, y: 0 },
                        parameters: {
                            apiParam: [{ name: 'pluginID', input: { value: { content: 'pid_123' } } }],
                        },
                    },
                ],
                edges: [],
                ...
                nodes: [
                    {
                        ...
                        title: 'Loop',
                        position: { x: 0, y: 0 },
                        edges: [{ source_node: 'n2', target_node: 'n3', source_port: 'output', target_port: 'input' }],
                    },
                ],
                edges: [],
            };
        ...
        it('should handle findNodeLineInYaml by title', () => {
            ...
            const yaml = {
                id: 'wf',
                nodes: [{ id: 'some_id', type: 1, title: 'MyTitle' }],
                edges: [],
            };
            try {
                convertYamlToClipboard(yaml, rawYaml);
        ...
        it('should find node line when id starts with prefix in rawYaml', () => {
            ...
            const yaml = {
                id: 'wf',
                nodes: [{ id: 123, type: 1, title: 'Test' }],
                edges: [],
            };
            try {
                convertYamlToClipboard(yaml, rawYaml);
        ...
        it('should return null when id and title not found in rawYaml lines', () => {
            ...
            const yaml = {
                id: 'wf',
                nodes: [{ id: 'missing', type: 1, title: 'NotFound' }],
                edges: [],
            };
            try {
                convertYamlToClipboard(yaml, rawYaml);
        ...
        it('should find node line by title when id not found in rawYaml', () => {
            ...
            const yaml = {
                id: 'wf',
                nodes: [{ id: 'other_id', type: 1, title: 'MyTitle' }],
                edges: [],
            };
            try {
                convertYamlToClipboard(yaml, rawYaml);
